...
[{capture append="oxidBlock_content"}]
    ...
    <div class="row page-header">
        ...
        <figure class="col-sm-3 img-responsive catImg">
...
<div class="col-sm-9 wrap">
    ...
    <div id="catLongDescLocator" class="truncate categoryDescription"><p class="toggledText">[{oxeval var=$actCategory->oxcategories__oxlongdesc}]</p></div>
